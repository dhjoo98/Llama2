...
#kinda think about if this kind of dependency should be allowed and/or accurate 
#is there a better way to tap into compiled pip's source code?
...
from .utils.modeling import load_checkpoint_in_model
...
def dispatch_model(
    ...
    Args:
        ...
        force_hooks (`bool`, *optional*, defaults to `False`):
            ...
            single device.
    """
    nvtx.range_push('dispatch model')
...
def load_checkpoint_and_dispatch(
    ...
    nvtx.range_push("load_checkpoint_in_model") #pop elsewhere 
    load_checkpoint_in_model(
        model,
        checkpoint,
