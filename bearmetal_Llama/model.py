#bear metal version of model.py 
...
#there classes and functions can have their parameter at initialization for now. 
...
class Attention(nn.Module):
    ...
    def __init__(self, args: ModelArgs):
        ...
        self.SSD2DRAM_flag = False
        self.DRAM2VRAM_flag = False

    def load_SSD2DRAM(self):
        torch.load()
        self.SSD2DRAM_flag = True

    def load_DRAM2VRAM(self):
        if (self.SSD2DRAM_flag == False):
            raise ValueError("SSD2DRAM load not taken")
    ...
    def forward(
        ...
        #then blow it 
        del linear layers
        torch.cuda.empty_cache() #see if this is actually viable. 
        #still has to deal with keeping 50% at DRAM
        self.SSD2DRAM_flag = False
        self.DRAM2VRAM_flag = False
        return output # Additional linear layer here. 
